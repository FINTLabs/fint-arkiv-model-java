...
public class DispensasjonAutomatiskFredaKulturminneResource extends Saksmappe implements FintMainObject, FintLinks {
    // Attributes
    @JsonIgnore
    @Override
    ...
    @NonNull
    private MatrikkelnummerResource matrikkelnummer;
    @NonNull
